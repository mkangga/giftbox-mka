...
const resources = {
  en: {
    translation: {
      ...
      "create.linkTitlePlaceholder": "e.g., Dana Kaget, ShopeePay link",
      "create.linkUrl": "URL",
      "create.linkUrlPlaceholder": "e.g., link.dana.id/...",
  ...
  id: {
    translation: {
      ...
      "create.giftIdPlaceholder": "cth: kado-ulang-tahun-sarah",
      ...
      "create.linkTitlePlaceholder": "cth: Link Dana Kaget, Sebar ShopeePay",
      "create.linkUrl": "URL",
      "create.linkUrlPlaceholder": "cth: link.dana.id/...",
